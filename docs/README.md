...
Melony is a small event-streaming runtime for AI agents with built-in Server-Driven UI (SDUI).
...
- [**Core Concepts**](./core-concepts.md): Events, Actions, Hooks, and Plugins.
