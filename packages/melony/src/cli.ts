...
program
  .command("studio")
  .description("Open Melony Studio (Coming soon!)")
  .action(() => {
    console.log("🍎 Melony Studio is under development.");
    console.log("This will soon launch a local Vite-based UI to interact with your agents.");
  });
