...
export function WelcomeScreen({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col bg-sidebar text-foreground relative overflow-hidden">
      ...
      {/* Right side: Login */}
      <div className="flex flex-1 flex-col items-center justify-center p-8 md:p-12 lg:p-20 bg-background transition-colors duration-300">
